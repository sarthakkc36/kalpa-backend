...
<html lang="en">
  ...
  <body>
    ...
    <section class="page-header">
      <div class="container">
        <h1>Educational Consultation</h1>
        <p>Expert guidance for schools, teachers, and educational institutions</p>
      </div>
    </section>
    <!-- Services Grid -->
    <section class="services-section">
      <div class="container">
        ...
        <div class="services-grid">
          <a href="school-consultation" style="text-decoration: none; color: inherit;">
            <div class="service-card">
              <div class="service-icon">
                <i class="fas fa-chalkboard-teacher"></i>
              </div>
              <h3>School Consultation</h3>
              <p>School Consultation</p>
            </div>
          </a>
          <a href="phonics" style="text-decoration: none; color: inherit;">
            <div class="service-card">
              <div class="service-icon">
                <i class="fas fa-graduation-cap"></i>
              </div>
              <h3>Phonics Consultation</h3>
              <p>Phonics Consultation</p>
            </div>
          </a>
        </div>
      </div>
    ...
    <section class="testimonials-section">
      ...
      <p class="section-subtitle">Hear from schools and educators we've worked with</p>
        ...
        <div class="testimonials-track">
          ...
          <div class="testimonial-card">
            <div class="testimonial-content">
              ...
              <div class="testimonial-author">
                ...
                <div class="author-info">
                  <h4>Pragati Budha</h4>
                  <p>Bodhisattva school,Pre school in charge</p>
                </div>
              </div>
              <div class="testimonial-rating">★★★★★</div>
            </div>
          ...
          <div class="testimonial-card">
            <div class="testimonial-content">
              ...
              <span class="quote-icon quote-right">"</span>
              <div class="testimonial-author">
                <img src="/images/Krishmita Thapa.webp" alt="Bodhisattva" class="author-image">
                <div class="author-info">
                  <h4>Krishmita Thapa</h4>
                  <p>Bodhisattva school,Pre school in charge
                  </p>
                </div>
              </div>
              <div class="testimonial-rating">★★★★★</div>
        ...
        <div class="timeline">
          <div class="timeline-item">
            ...
            <div class="timeline-content">
              <h3>Assessment</h3>
              <p>Initial evaluation and needs analysis</p>
            </div>
          </div>
          <div class="timeline-item">
            ...
            <div class="timeline-content">
              <h3>Planning</h3>
              <p>Customized strategy development</p>
            </div>
          </div>
          <div class="timeline-item">
            ...
            <div class="timeline-content">
              ...
              <p>Guided execution and support</p>
            </div>
          </div>
          <div class="timeline-item">
            ...
            <div class="timeline-content">
              <h3>Monitoring</h3>
              <p>Progress tracking and optimization</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- Consultation Form -->
    <section id="consultation-form" class="form-section">
      <div class="container">
        <div class="form-wrapper">
          <div class="form-info">
            <h2>Request Consultation</h2>
            <p>Get expert guidance for your institution</p>
            <ul class="info-list">
              ...
              <li><i class="fas fa-check"></i>Regular Follow-up</li>
            </ul>
          </div>
          <!-- Replace your existing consultation form with this -->
          <form action="https://formspree.io/f/xjkvarnq" method="POST" class="consultation-form">
            ...
            <div class="form-group">
              <select id="consultationType" name="consultationType" required>
                ...
                <option value="curriculum">Curriculum Consultation</option>
                <option value="phonics">Phonics Program</option>
                <option value="montessori">Montessori Implementation</option>
